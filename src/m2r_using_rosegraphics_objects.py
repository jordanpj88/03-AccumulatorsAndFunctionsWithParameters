...
#                square1 = rg.Square(rg.Point(100,100), 25)
#                rectangle1 = rg.Rectangle(rg.Point(100, 100), rg.Point(100, 300))
#
...
#        necessary?  Why?
#           When you want to view to displayed objects in teh window. Without it the window would close right after away
#
